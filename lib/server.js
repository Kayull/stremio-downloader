...
async function init(cb) {
	...
	const serverPort = await getPort({ port: preferredPort })
	if (serverPort !== preferredPort)
		throw new Error('Stremio Downloader is already running on http://127.0.0.1:8189/downloader/. Stop the existing instance before starting another one.')
