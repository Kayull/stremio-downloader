...
function normalizePersistLoginState(value) {
	return value !== false
}
...
module.exports = {
	...
	getSettings: () => {
		...
		return {
			...
			persistLoginState: normalizePersistLoginState(settings.persistLoginState),
	...
	getPersistLoginState: () => {
		const settings = readSettings()
		return normalizePersistLoginState(settings.persistLoginState)
	},
	setPersistLoginState: enabled => {
		const settings = readSettings()
		settings.persistLoginState = normalizePersistLoginState(enabled)
		writeSettings(settings)
		return settings.persistLoginState
	},
	getThemeMode: () => {
		const settings = readSettings()
